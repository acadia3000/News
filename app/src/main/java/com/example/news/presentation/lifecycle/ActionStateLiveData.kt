package com.example.news.presentation.lifecycle

import androidx.lifecycle.MutableLiveData
import androidx.lifecycle.Observer
import com.example.news.presentation.model.state.ActionState
...
class ActionStateLiveData<T>(
    ...
    fun loadMore(withLoadingProgress: Boolean = false) {
        if (isLoading()) {
            return
        }
